...
public class ConsumeMenu : BaseMenu<ConsumeMenu>
{
    ...
    public void UpdataItem()
    {
        ...
        {
            if (BackPack.Instance.type[item.id] == 2)
            {
                ...
                {
                    Transform GO = GameObject.Instantiate(BackPack.Instance.dic[tp], BackPack.Instance.ts3).transform;
