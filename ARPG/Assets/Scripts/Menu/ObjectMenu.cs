...
public class ObjectMenu : BaseMenu<ObjectMenu>
{
    ...
    public void UpdataItem()
    {
        ...
        {
            if (BackPack.Instance.type[item.id] == 3)
            {
                ...
                {
                    Transform GO = GameObject.Instantiate(BackPack.Instance.dic[tp], BackPack.Instance.ts4).transform;
